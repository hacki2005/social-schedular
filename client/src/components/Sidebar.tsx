import {CalendarDaysIcon, LayoutDashboard, LogOutIcon, Wand2Icon} from "lucide-react";
...
void}) => {
    ...
    const navItems = [
        ...
        {name: "Accounts", icon: LayoutDashboard,path:"/accounts"},
    ...
    return (
        ...
        border-r border-slate-200 flex flex-col h-full transform transition-transform
        ...
        md:relative md:translate-x-0 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
            ...
            <div className="p-6 pb-4">
                <div className=" text-xl tracking-tight text-slate-800
                ...
                <nav className="flex-1 px-3 space-y-1">
                    {navItems.map((item)=>{
                        ...
                        return(
                            ...
                            rounded text-sm transition-all duration-150 border ${isActive ?
                            "bg-red-50 text-red-600 border-red-100 "
                               ...
                               "text-red-500" : "text-slate-500" }`}/>
                                {item.name}
                                {isActive && <span className="ml-auto w-1.25 h-5 rounded-full
                                bg-red-500"/>}
            ...
            <div className="p-4 border-t border-slate-100">
                ...
                transition-colors">
                    <div className="size-8 rounded-full bg-linear-to-br
                    from-red-400 to-pink-400 flex items-center justify-center
                    ...
                    rounded text-sm text-slate-500 hover:bg-red-50  hover:text-red-500 transition-all duration-150">
