...
import {dummyAccountsData, PLATFORMS} from "../assets/assets.tsx";
...
const Accounts = () => {
    ...
    const fetchAccounts = async (isSync = false,platform?: string | null,sucessMsg?:string)=>{
    ...
    return (
        <div className="space-y-8 max-w-4xl">
            ...
            gap-4 text-sm">
                ...
                <button onClick={()=>setShowPlatformPicker(true)} className="flex items-center gap-2 px-5 py-2.5 bg-red-500 hover:bg-red-600
