...
import { dummyGenerationData, PLATFORMS } from "../assets/assets.tsx";
import {
    ArrowRightIcon,
    CalendarIcon,
    ClockIcon,
    HistoryIcon,
    Loader2Icon, TimerIcon,
    Wand2Icon,
    XIcon,
} from "lucide-react";
...
const AiComposer = () => {
    ...
    const [generations, setGeneration] = useState<any[]>([]);
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-12 pb-20 animated-in fade-in duration-700">
            {/* Input Section */}
          ...
          />
                ...
                ${generateImage ? "bg-red-500" : "bg-slate-200"}`}
                            >
                <span
                    className={`pointer-events-none size-4 transform translate-y-0.5
                    ...
                    {gen.tone}
                                ...
                                <div className="flex items-center gap-2 pt-2">
                                    <button
                                        ...
                                        className="flex-1 bg-slate-100 hover:bg-red-500 hover:text-white text-slate-600 text-xs py-2.5 rounded-lg transition"
                                    >
                                        Schedule Post
                                    </button>
                                </div>
